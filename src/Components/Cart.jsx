  ...
  return (
    <>
      ...
      >
        ...
        }): <h2 className="text-center text-xl text-gray-700 font-bold">Your cart is empty</h2>}
      ...
      <FaShoppingCart
        onClick={() => setActiveCart(!activeCart)}
        className={`rounded-full bg-white shadow-md text-5xl fixed p-3 bottom-4 right-0 ${totalQty > 0 &&  "animate-bounce delay-500 transition-all"}`}
      />
    </>
  );
}
